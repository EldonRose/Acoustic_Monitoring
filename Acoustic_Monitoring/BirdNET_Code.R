...
wk19.test <- list.files(path="E:/2025_AM_Data/Eldon1/Week16", full.names = TRUE) 
E1.wk19 <- as.list(wk19.test)
...
E1.wk19.25 <- lapply(E1.wk19, function(x) {E1.test <- predict_species_from_audio_file(model, x, min_confidence = 0.3, filter_species = sp, keep_empty = FALSE)})
E1.wk19.25 <- as.data.frame(E1.wk19.25)
write.csv(E1.wk19.25, "C:/Users/rwetz/Documents/GitHub/Acoustic_Monitoring/Acoustic_Monitoring/codetest.csv", row.names = FALSE)
